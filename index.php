...
<!-- Обо мне-->
  ...
  <div class="row">
    ...
    <div class="col-lg-5 wow fadeInLeft ">
      <h4  class="skills_title" >Мой топ классов</h4>
            <p  class="skills_text">Чернокнижник</p>
      <div class="container">

        <div class="skills html">.</div>
      </div>

      <p class="skills_text" >Ферал</p>
      <div class="container">
        <div class="skills css">.</div>
      </div>

      <p class="skills_text" >Разбушеник</p>
      <div class="container">
        <div class="skills js">.</div>
      </div>

      <p class="skills_text" >Bootstrap </p>
      <div class="container">
   ...
   <div class="container  ">
     <h2 class="about_title" >   Хотите Буст ? </h2>
        <p class="abot_text" > Lorem Ipsum - это текст-"рыба", часто используемый в печати и вэб-дизайне. Lorem Ipsum является стандартной "рыбой" для текстов на латинице с начала XVI века.</p>
          <div class="row">
            <div class="contact">
   ...
   <footer>
    ...
    <div class="col-lg-12">
      <p class="footer_text" >(с) 2021. Сасите.</p>
   </div>
